...
public class BlockFermenter extends BlockBeerCraftEntityBlock {
    private IIcon  iconTop;
    private IIcon  iconSide;
    private IIcon iconBottom;
    
    public BlockFermenter() {
        super( Names.Blocks.FERMENTER, Material.iron );
    }
    ...
    public boolean onBlockActivated( World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if( world.isRemote ) {
            ...
            FMLNetworkHandler.openGui( player, BeerCraft.instance, GuiIDs.FERMENTER, world, x, y, z );
            return true;
        }
    }
    ...
    public void registerBlockIcons( IIconRegister r ) {
        this.iconTop = r.registerIcon( Textures.RESOURCE_PREFIX + "fermenter_top" );
        this.iconSide = r.registerIcon( Textures.RESOURCE_PREFIX + "fermenter_side" );
